...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt, memory,
        ...
        if self.use_local_attn and memory_valid_mask is not None:
            ...
            if k_content.dtype!=k_content_valid.dtype:
                k_content_valid = k_content_valid.to(k_content.dtype)
            ...
            if v_valid.dtype!=v.dtype:
                v_valid = v_valid.to(v.dtype)
            ...
            if k_pos_valid.dtype!=k_pos.dtype:
                k_pos_valid = k_pos_valid.to(k_pos.dtype)
