...
print(f"Rank: {os.environ.get('RANK', 'N/A')}, Local Rank: {os.environ.get('LOCAL_RANK', 'N/A')}, "
      f"Assigned GPU: {torch.cuda.current_device()}, Available GPUs: {torch.cuda.device_count()}")
...
def parse_config():
    ...
    parser.add_argument('--batch_size', type=int, default=40, required=False, help='batch size for training')
    # parser.add_argument('--batch_size', type=int, default=80, required=False, help='batch size for training')
    ...
    parser.add_argument('--extra_tag', type=str, default='act_mtr', help='extra tag for this experiment')
    ...
    parser.add_argument('--num_classes', default=5, help='')
