...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type=str, help='path to save processed data',default='<local_dataset_root>/waymo/training_interactive_processed2')
    ...
    # parser.add_argument('--save_path', type=str, help='path to save processed data',default='<local_dataset_root>/waymo/validation_interactive_processed2')
