...
#SBATCH --job-name=imotion_mtr_7mar
...
# torchrun --nproc-per-node 3 --master_port ${PORT} /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
#     --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_iccv_feb_2025/train_imotion_e2e_complex_pretrained.yaml

# torchrun --nproc-per-node 3 --master_port ${PORT} /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
#     --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_iccv_feb_2025/train_imotion_e2e_mtr.yaml

# torchrun --nproc-per-node 3 /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
#     --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_iccv_feb_2025/train_imotion_e2e_mtr.yaml

torchrun --nproc-per-node 3 /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
    --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_configs_mar_2025/train_imotion_e2e.yaml

## imotion, e2e
# torchrun --nproc-per-node 3 --master_port ${PORT} /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
#     --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_iccv_feb_2025/train_imotion_02_q_complex_e2e.yaml

# torchrun --nproc-per-node 3 --master_port ${PORT} /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
#     --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_iccv_feb_2025/train_imotion_e2e_3epochs.yaml
# torchrun --nproc-per-node 3 --master_port ${PORT} /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
#     --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_iccv_feb_2025/train_imotion_e2e_loraDropout.yaml
# torchrun --nproc-per-node 3 --master_port ${PORT} /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
#     --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_iccv_feb_2025/train_imotion_e2e_largernorm.yaml
# torchrun --nproc-per-node 3 --master_port ${PORT} /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
#     --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_iccv_feb_2025/train_imotion_e2e.yaml
## MTR, e2e
# torchrun --nproc-per-node 3 --master_port ${PORT} /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
#     --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_iccv_feb_2025/train_imotion_mtr.yaml
## MTR, e2e no caption
# torchrun --nproc-per-node 3 --master_port ${PORT} /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
#     --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_iccv_feb_2025/train_imotion_mtr_noCaption.yaml
# torchrun --nproc-per-node 2 /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_iccv_feb_2025/train_imotion_mtr.yaml

# torchrun --nproc-per-node 3 --master_port ${PORT} /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
#     --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_iccv_feb_2025/train_imotion.yaml

# torchrun --nproc-per-node 3 --master_port ${PORT} /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
#     --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_iccv_feb_2025/train_imotion_noCaption.yaml

# timeout 14100s torchrun --nproc-per-node 3 --master_port ${PORT} /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
#     --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_feb/train_imotion.yaml

# sbatch $0

# timeout 14000s torchrun --nproc-per-node 1 /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
#     --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_feb/train_imotion.yaml

# torchrun --nproc-per-node 3 --master_port ${PORT}  /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
# --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_cvpr_rebuttal/train_simple.yaml
# CUDA_LAUNCH_BLOCKING=1 TORCH_DISTRIBUTED_DEBUG=DETAIL torchrun --nproc_per_node=2 --nnodes=1 --master_port ${PORT} /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
        # --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_cvpr_rebuttal/train_complex03.yaml
## 26 dec
# timeout 13190s torchrun --nproc-per-node 2 --master_port ${PORT} /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
#     --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_configs_dec/train/train_kv_caption_28dec.yaml

# sbatch $0

#/home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_configs_dec/train/train_nuplan_complex_28dec.yaml
