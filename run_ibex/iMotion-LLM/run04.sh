...
#SBATCH --job-name=alwyasgt_template02
...
timeout 10800s torchrun --nproc-per-node 2 --master_port ${PORT} /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train.py \
    --cfg-path /home/felembaa/projects/iMotion-LLM-ICLR/trajgpt/train_configs_dec/train/train_kv_caption_26dec_gt_traj_02.yaml
