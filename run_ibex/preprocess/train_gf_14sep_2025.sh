...
python /home/felembaa/projects/iMotion-LLM-ICLR/gameformer/data_preprocess_v09_2agent.py \
  --load_path /ibex/project/c2278/felembaa/datasets/waymo/training/ \
  --run_num $run_num \
  --save_path /ibex/project/c2278/felembaa/datasets/waymo/gameformer/sep14_2025_2a/training \
