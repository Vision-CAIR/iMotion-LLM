...
scontrol update JobID=$SLURM_JOB_ID JobName=nuplan_sing_${run_num}
...
python /home/felembaa/projects/iMotion-LLM-ICLR/gameformer/nuplan_preprocess/data_preprocess.py \
  --data_path /ibex/project/c2278/felembaa/datasets/nuplan/test/data/cache/test\
  --save_path /ibex/project/c2278/felembaa/datasets/nuplan/test/test_singapore_processed\
  --processes 10 --run_num $run_num --map_names sg-one-north
