...
python /home/felembaa/projects/iMotion-LLM-ICLR/gameformer/data_preprocess_v07.py \
  --load_path /ibex/project/c2278/felembaa/datasets/waymo/training/ \
  --run_num $run_num \
  --save_path /ibex/project/c2278/felembaa/datasets/waymo/gameformer/training_30sep \
