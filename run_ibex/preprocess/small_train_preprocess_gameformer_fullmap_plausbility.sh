...
python ~/projects/iMotion-LLM-ICLR/gameformer/data_preprocess_v06.py \
    ...
    --save_path /ibex/project/c2278/felembaa/datasets/waymo/gameformer/train_small_17may_fullmap_wPlausbility \
    --not_debug --use_multiprocessing --processes 10 --small_data --run_num $run_num --plausbility