...
python ~/projects/iMotion-LLM-ICLR/gameformer/data_preprocess_v06.py \
    ...
    --save_path /ibex/project/c2278/felembaa/datasets/waymo/gameformer/validation_11may_fullmap \
    --not_debug --use_multiprocessing --processes 32 --small_data --run_num $run_num --delete_old