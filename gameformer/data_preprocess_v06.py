...
def vizualize_background(segment, segment_type, fig, categ, ax, force_color):
    ## Guide:
...
class DataProcess(object):
    ...
    def plt_scene(self, agent_1=None, agent_2=None, other_agents=None, figure_center=None, max_num_lanes=10):
