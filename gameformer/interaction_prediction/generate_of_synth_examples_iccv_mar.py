    ...
    # for epoch in range(epochs):
        ...
        # else:
            ...
            with torch.no_grad():
                ...
                , num_classes=5, args=args, pos1_synth=True)
                raise "Code done"
                # results_dict = validation_epoch(valid_data, model, epoch, act= args.act or args.act_dec, two_agent_act=False, save_dir=log_path+'results/', num_classes=8, args=args)
...
def main():
    ...
    with torch.no_grad():
        results_dict = validation_epoch_pkl(
            ...
            two_agent_act=False, save_dir="", num_classes=5, args=args, pos1_synth=True
        )
...
if __name__ == "__main__":
    ...
    # model
    parser.add_argument("--level", type=int, help='decoder reasoning levels (K)', default=1) # default: 6, 3
    ...
    parser.add_argument("--act", help='act', default=False)
    ...
    parser.add_argument('--valid_set', type=str, help='path to train data', default='/ibex/project/c2278/felembaa/datasets/waymo/gameformer/feb16_2025/training')
    ...
    parser.add_argument('--load_dir', type=str, help='name to load ckpts from log path (e.g. epochs_0.pth)', default='/ibex/project/c2278/felembaa/models/gameformer/feb_18_2025/cgf_l1/epochs_29.pth')
    ...
    parser.add_argument('--save_path', type=str, help='', default='/ibex/project/c2278/felembaa/datasets/waymo/gameformer/feb16_2025/training_synth_pos')
