...
if __name__ == "__main__":
    ...
    parser.add_argument('--valid_set', type=str, help='path to train data', default='<internal_dataset_root>/waymo/gameformer/feb16_2025/training')
    ...
    parser.add_argument('--load_dir', type=str, help='name to load ckpts from log path (e.g. epochs_0.pth)', default='<internal_model_root>/gameformer/feb_18_2025/cgf_l1/epochs_29.pth')
    ...
    parser.add_argument('--save_path', type=str, help='', default='<internal_dataset_root>/waymo/gameformer/feb16_2025/training_synth_pos')
