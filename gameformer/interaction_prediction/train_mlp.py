...
def extract_act_for_sample(data_list, idx):
    ...
    """
    data_dir = "<internal_dataset_root>/waymo/gameformer/feb16_2025/training/*"
    try:
        np_filename = data_list[idx]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_model", type=str, help='save model directory, not saved if not provided', default='<legacy_repo_root>/gameformer/model/checkpoints')
