...
if __name__ == "__main__":
    ...
    parser.add_argument('--load_dir', type=str, help='name to load ckpts from log path (e.g. epochs_0.pth)', default='<internal_model_root>/gameformer/feb_18_2025/cgf/epochs_1.pth')
