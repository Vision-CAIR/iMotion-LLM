...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_set', type=str, help='path to train data', default='data/processed/waymo/gameformer/train')
    ...
    parser.add_argument('--valid_set', type=str, help='path to train data', default='data/processed/waymo/gameformer/val')
    ...
    if args.save_path=='':
        if args.save_model:
            ...
            args.save_path = str(REPO_ROOT / 'outputs' / 'gameformer' / args.name)
