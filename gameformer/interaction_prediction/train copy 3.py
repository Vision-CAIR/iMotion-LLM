...
def main():
    ...
    if not args.eval_only:
        ...
        train_dataset = DrivingData(args.train_set+'/*', act=args.act_dec or args.act_kv, full_map=args.full_map, ego_act_only=args.ego_act_only, nuplan=args.nuplan, random_drop_act=not args.no_random_drop_act, files_with_act_only=args.files_with_act_only)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--load_dir', type=str, help='name to load ckpts from log path (e.g. epochs_0.pth)', default='<internal_model_root>/gameformer/feb_18_2025/gf/epochs_29.pth')
    ...
    # python <legacy_repo_root>/gameformer/interaction_prediction/train.py --new_eval_mode gt1 --new_eval --eval_only --load_dir <internal_model_root>/gameformer/feb_18_2025/gf/epochs_29.pth --workers 4 --batch_size 64 --level 3 --modalities 6 --future_len 80 --neighbors_to_predict 0
