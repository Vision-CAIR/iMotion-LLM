...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_set', type=str, help='path to train data', default='<internal_dataset_root>/waymo/gameformer/training_small_1jul')
    ...
    parser.add_argument('--valid_set', type=str, help='path to train data', default='<internal_dataset_root>/waymo/gameformer/validation_3jul')
    ...
    # parser.add_argument('--load_dir', type=str, help='name to load ckpts from log path (e.g. epochs_0.pth)', default='<internal_model_root>/gameformer/cgf_7jul_fulldata/epochs_20.pth')
    # parser.add_argument('--load_dir', type=str, help='name to load ckpts from log path (e.g. epochs_0.pth)', default='<internal_model_root>/gameformer/cgf_11jul_smalldata_2agent/epochs_29.pth')
    parser.add_argument('--load_dir', type=str, help='name to load ckpts from log path (e.g. epochs_0.pth)', default='<internal_model_root>/gameformer/cgf_2jul_smalldata/epochs_29.pth')
