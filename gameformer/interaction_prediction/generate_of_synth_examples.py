...
if __name__ == "__main__":
    ...
    parser.add_argument('--valid_set', type=str, help='path to train data', default='<internal_dataset_root>/waymo/gameformer/training_28nov')
    ...
    parser.add_argument('--save_path', type=str, help='', default='<internal_dataset_root>/waymo/gameformer/training_28nov_synth_pos')
