...
if __name__ == "__main__":
    ...
    parser.add_argument('--valid_set', type=str, help='path to train data', default='<internal_dataset_root>/waymo/gameformer/feb16_2025/validation_more_data/validation')
    ...
    parser.add_argument('--load_dir', type=str, help='name to load ckpts from log path (e.g. epochs_0.pth)', default='<internal_model_root>/gameformer/sep_14_2025/cgf_l1_2agent_egoInstruct/epochs_29.pth')
    ...
    # args.load_dir = '<internal_model_root>/gameformer/sep_14_2025/cgf_l1_2agent_egoInstruct/epochs_29.pth'
    # args.level = 1
    # args.act_dec = True

    # args.load_dir = '<internal_model_root>/gameformer/sep_14_2025/cgf_l1_2agent_instructBoth/epochs_29.pth'
    # args.level = 1
    # args.act_dec = True

    # args.load_dir = '<internal_model_root>/gameformer/sep_14_2025/cgf_l3_2agent_egoInstruct/epochs_29.pth'
    # args.level = 3
    # args.act_dec = True

    # args.load_dir = '<internal_model_root>/gameformer/sep_14_2025/cgf_l3_2agent_instructBoth/epochs_29.pth'
    # args.level = 3
    # args.act_dec = True

    # args.load_dir = '<internal_model_root>/gameformer/sep_14_2025/gf_l1_2agent_egoInstruct/epochs_29.pth'
    # args.level = 1
    # args.act_dec = False

    args.load_dir = '<internal_model_root>/gameformer/sep_14_2025/gf_l3_2agent_egoInstruct/epochs_29.pth'
    args.level = 3
    args.act_dec = False
