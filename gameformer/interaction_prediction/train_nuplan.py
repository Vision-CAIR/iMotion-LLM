...
def main():
    ...
    # load ckpts:
    curr_ep = 0
    # ignore continue learning for nuplan finetuning
    # if args.load_dir != '':
...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_set', type=str, help='path to train data', default='/ibex/project/c2278/felembaa/datasets/nuplan/gpt_prompt_14types')
    ...
    # args.act_dec = True
    args.nuplan = True
    # args.save_path = '/ibex/project/c2278/felembaa/models/gameformer/3_wacv_rebuttal/temp'
