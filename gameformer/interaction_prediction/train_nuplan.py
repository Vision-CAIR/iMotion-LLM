...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_set', type=str, help='path to train data', default='<internal_dataset_root>/nuplan/gpt_prompt_14types')
    ...
    # args.act_dec = True
    args.nuplan = True
    # args.save_path = '<internal_model_root>/gameformer/3_wacv_rebuttal/temp'
