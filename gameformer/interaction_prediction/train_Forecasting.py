...
import time
from gameformer.model.GameFormer_Forecasting import GameFormer_
...
if __name__ == "__main__":
    ...
    parser.add_argument("--weighted_sampling", action="store_true", help='weighted_sampling mode', default=True)
