...
# num_examples_to_validate
# Default
CURRENT_SPEED_CAN_STOP_THRESHOLD = 18 # 8.33, default: 18, 25 --> Check stationary qualitative & stationary stats
MAX_SPEED_INCREASE = 0.52 # m/s² -> 15 km/h over 8s [1.071: 30 km/h, 0.268: 7.5 km/h, 0.52: 15 km/h]
MAX_LOOK_AHEAD = 60 # 60, 100, 500
USE_SPEED_LIMIT_IN_MAX_DISTANCE = True
USE_ACCEL_MAX_TRAVEL_DISTANCE = True
DIST_THRESHOLD, ANGLE_THRESHOLD = 1, 10
# #
# CURRENT_SPEED_CAN_STOP_THRESHOLD = 8.33 # 8.33, default: 18, 25 --> Check stationary qualitative & stationary stats
# MAX_SPEED_INCREASE = 0.52 # m/s² -> 15 km/h over 8s [1.071: 30 km/h, 0.268: 7.5 km/h, 0.52: 15 km/h]
# MAX_LOOK_AHEAD = 60 # 60, 100, 500
# USE_SPEED_LIMIT_IN_MAX_DISTANCE = True
# USE_ACCEL_MAX_TRAVEL_DISTANCE = True
# DIST_THRESHOLD, ANGLE_THRESHOLD = 1, 10
# #
# CURRENT_SPEED_CAN_STOP_THRESHOLD = 25 # 8.33, default: 18, 25 --> Check stationary qualitative & stationary stats
# MAX_SPEED_INCREASE = 0.52 # m/s² -> 15 km/h over 8s [1.071: 30 km/h, 0.268: 7.5 km/h, 0.52: 15 km/h]
# MAX_LOOK_AHEAD = 60 # 60, 100, 500
# USE_SPEED_LIMIT_IN_MAX_DISTANCE = True
# USE_ACCEL_MAX_TRAVEL_DISTANCE = True
...
# #
# CURRENT_SPEED_CAN_STOP_THRESHOLD = 18 # 8.33, default: 18, 25 --> Check stationary qualitative & stationary stats
# MAX_SPEED_INCREASE = 1.071 # m/s² -> 15 km/h over 8s [1.071: 30 km/h, 0.268: 7.5 km/h, 0.52: 15 km/h]
# MAX_LOOK_AHEAD = 60 # 60, 100, 500
# USE_SPEED_LIMIT_IN_MAX_DISTANCE = True
# USE_ACCEL_MAX_TRAVEL_DISTANCE = True
# DIST_THRESHOLD, ANGLE_THRESHOLD = 1, 10
# #
# CURRENT_SPEED_CAN_STOP_THRESHOLD = 18 # 8.33, default: 18, 25 --> Check stationary qualitative & stationary stats
# MAX_SPEED_INCREASE = 0.268 # m/s² -> 15 km/h over 8s [1.071: 30 km/h, 0.268: 7.5 km/h, 0.52: 15 km/h]
# MAX_LOOK_AHEAD = 60 # 60, 100, 500
# USE_SPEED_LIMIT_IN_MAX_DISTANCE = True
# USE_ACCEL_MAX_TRAVEL_DISTANCE = True
# DIST_THRESHOLD, ANGLE_THRESHOLD = 1, 10
...
# MAX_SPEED_INCREASE = 0.52 # m/s² -> 15 km/h over 8s [1.071: 30 km/h, 0.268: 7.5 km/h, 0.52: 15 km/h]
# MAX_LOOK_AHEAD = 60 # 60, 100, 500
# USE_SPEED_LIMIT_IN_MAX_DISTANCE = False
# USE_ACCEL_MAX_TRAVEL_DISTANCE = False
# DIST_THRESHOLD, ANGLE_THRESHOLD = 1, 10
# #
# CURRENT_SPEED_CAN_STOP_THRESHOLD = 18 # 8.33, default: 18, 25 --> Check stationary qualitative & stationary stats
# MAX_SPEED_INCREASE = 0.52 # m/s² -> 15 km/h over 8s [1.071: 30 km/h, 0.268: 7.5 km/h, 0.52: 15 km/h]
# MAX_LOOK_AHEAD = 100 # 60, 100, 500
# USE_SPEED_LIMIT_IN_MAX_DISTANCE = False
# USE_ACCEL_MAX_TRAVEL_DISTANCE = False
# DIST_THRESHOLD, ANGLE_THRESHOLD = 1, 10
# #
...
# USE_SPEED_LIMIT_IN_MAX_DISTANCE = True
# USE_ACCEL_MAX_TRAVEL_DISTANCE = True
# DIST_THRESHOLD, ANGLE_THRESHOLD = 2, 15
...
def vizualize_background(segment, segment_type, fig, categ, ax, force_color=None):
    ...
    # plt shapes per type
    center_plt_info = [('lightgray','-', 0.1),('gray','solid', 0.4), ('gray','solid', 0.4), ('b','dashed', 0.2),] ### MAKE THIS LANES RED
...
class DataProcess(object):
    ...
    def get_drivable_lanes(self, ego, use_neighbouring_lanes=True):
        ...
        dist_threshold, angle_threshold = DIST_THRESHOLD, ANGLE_THRESHOLD# 1m, 5 degrees
        ...
        if current_speed<=CURRENT_SPEED_CAN_STOP_THRESHOLD: # since stationary indicate the vehicle does not exceed 5 meters in 8 seconds, we assume this is the max possible speed that the vehicle can break from to be a safe yet firm breaking
        # if current_speed<=24: # m/s, replace with 40 m/s for more aggressive stopping
            vehicle_can_stop = True
        else:
            vehicle_can_stop = False

        max_possible_speed_increase = MAX_SPEED_INCREASE
        ...
        min_future_speeds = [current_speed-(i*max_possible_speed_decrease) for i in range(8) if current_speed-(i*max_possible_speed_decrease)>0] # m/s for 8 the current speed and 7 seconds in the future speeds
        min_travel_distance = sum(min_future_speeds)
        if USE_ACCEL_MAX_TRAVEL_DISTANCE:
            if USE_SPEED_LIMIT_IN_MAX_DISTANCE:
                max_distance = min(min(speed_limit*8, max_travel_distance), MAX_LOOK_AHEAD) # max 60 meters
            else:
                max_distance = min(max_travel_distance, MAX_LOOK_AHEAD) # max 60 meters
        else:
            max_distance = MAX_LOOK_AHEAD
        min_distance = max(0, min_travel_distance)
    ...
    def process_data(self, viz=True,test=False):
        ...
        #     if data_file!='/ibex/project/c2278/felembaa/datasets/waymo/validation_interactive/validation_interactive.tfrecord-00090-of-00150':
        #         continue
            # if iii<149:
            #     continue
            ...
            for data in dataset:
                ...
                #     continue
                # if 'aa2c6b1eabc24c80' not in scenario_id:
                #     continue
...
if __name__ == "__main__":
    ...
    # parser.add_argument('--save_path', type=str, help='path to save processed data', default = '/ibex/project/c2278/felembaa/datasets/waymo/gameformer/feb16_2025/training_verification')
    parser.add_argument('--save_path', type=str, help='path to save processed data', default = '/ibex/project/c2278/felembaa/iccv_rebuttal_2025_qualitative_preprocessing/qual_check')
    ...
    parser.add_argument('--processes', type=int, help='multiprocessing process num', default=16)
    ...
    # USE_SPEED_LIMIT_IN_MAX_DISTANCE = True
    # USE_ACCEL_MAX_TRAVEL_DISTANCE = True
    args.save_path = f"/ibex/project/c2278/felembaa/iccv_rebuttal_2025_qualitative_preprocessing/CURRENT_SPEED_CAN_STOP_THRESHOLD_{CURRENT_SPEED_CAN_STOP_THRESHOLD}_MAX_SPEED_INCREASE_{MAX_SPEED_INCREASE}_MAX_LOOK_AHEAD_{MAX_LOOK_AHEAD}_USE_SPEED_LIMIT_IN_MAX_DISTANCE_{USE_SPEED_LIMIT_IN_MAX_DISTANCE}_USE_ACCEL_MAX_TRAVEL_DISTANCE_{USE_ACCEL_MAX_TRAVEL_DISTANCE}"
