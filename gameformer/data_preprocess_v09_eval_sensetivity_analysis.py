...
class DataProcess(object):
    ...
    def process_data(self, viz=True,test=False):
        ...
        #     if data_file!='<internal_dataset_root>/waymo/validation_interactive/validation_interactive.tfrecord-00090-of-00150':
        #         continue
            # if iii<149:
            #     continue
...
if __name__ == "__main__":
    ...
    # parser.add_argument('--save_path', type=str, help='path to save processed data', default = '<internal_dataset_root>/waymo/gameformer/feb16_2025/training_verification')
    parser.add_argument('--save_path', type=str, help='path to save processed data', default = '<internal_qualitative_root>/qual_check')
    ...
    # USE_SPEED_LIMIT_IN_MAX_DISTANCE = True
    # USE_ACCEL_MAX_TRAVEL_DISTANCE = True
    args.save_path = f"<internal_qualitative_root>/CURRENT_SPEED_CAN_STOP_THRESHOLD_{CURRENT_SPEED_CAN_STOP_THRESHOLD}_MAX_SPEED_INCREASE_{MAX_SPEED_INCREASE}_MAX_LOOK_AHEAD_{MAX_LOOK_AHEAD}_USE_SPEED_LIMIT_IN_MAX_DISTANCE_{USE_SPEED_LIMIT_IN_MAX_DISTANCE}_USE_ACCEL_MAX_TRAVEL_DISTANCE_{USE_ACCEL_MAX_TRAVEL_DISTANCE}"
