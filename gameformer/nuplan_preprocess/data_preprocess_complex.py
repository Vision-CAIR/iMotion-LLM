...
class DataProcessor(object):
    ...
    def work(self, save_dir, debug=False):
        ...
        with open(REPO_ROOT / "gameformer" / "nuplan_preprocess" / "scenario_situation_gpt_info.json", 'r') as file:
        ...
        for scenario in self._scenarios:
            ...
            if valid_instruct:
                ...
                if args.save_gpt_prompt:
                    ...
                    scenario_template_data_dir = REPO_ROOT / "gameformer" / "nuplan_preprocess" / "prompts_templates" / f"{scenario_type}.txt"
...
if __name__ == "__main__":
    ...
    # parser.add_argument('--data_path', type=str, help='path to raw data', default='<internal_dataset_root>/nuplan/train/data/cache/train_pittsburgh')
    # parser.add_argument('--data_path', type=str, help='path to raw data', default='<internal_dataset_root>/nuplan/train/data/cache/train_boston')
    parser.add_argument('--data_path', type=str, help='path to raw data', default='data/raw/nuplan/cache/train_combined')
    # parser.add_argument('--data_path', type=str, help='path to raw data', default='<internal_dataset_root>/nuplan/train/data/cache/train_singapore')
    ...
    parser.add_argument('--map_path', type=str, help='path to map data', default='data/raw/nuplan/maps')
    ...
    parser.add_argument('--save_path', type=str, help='path to save processed data', default='data/processed/nuplan/gpt_prompt_14types')
    ...
    if True:
        ...
        worker(use_process_pool=True if not args.debug else False, max_workers=max_workers)
