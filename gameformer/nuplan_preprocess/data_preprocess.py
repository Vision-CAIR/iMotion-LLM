...
class DataProcessor(object):
    ...
    def plot_scenario(self, data, special_lanes=None, img_name='ex.png', draw_traj=True):
        ...
        if special_lanes is not None:
            ...
            # create_map_raster(data['right_boundary'], data['crosswalks'], np.array([]))
    ...
    def work(self, save_dir, debug=False):
        ...
        for scenario in self._scenarios:
            ...
            # print(feasible_directions)
            templateLLM_filename = f"{save_dir}_templateLLM/{data['map_name']}_{data['token']}.txt"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--run_num', type=int, help='', default=3)
    ...
    os.makedirs(args.save_path+"_templateLLM", exist_ok=True)
    # get scenarios
