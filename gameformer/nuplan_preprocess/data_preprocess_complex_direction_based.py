...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type=str, help='path to save processed data', default='/ibex/project/c2278/felembaa/datasets/nuplan/gpt_prompt_14types_v02_5clsDirections')
