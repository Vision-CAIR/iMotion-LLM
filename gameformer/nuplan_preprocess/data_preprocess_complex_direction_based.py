...
class DataProcessor(object):
    ...
    def work(self, save_dir, debug=False):
        ...
        with open("<legacy_repo_root>/gameformer/nuplan_preprocess/scenario_situation_gpt_info.json", 'r') as file:
        ...
        for scenario in self._scenarios:
            ...
            if valid_instruct:
                ...
                if args.save_gpt_prompt:
                    ...
                    scenario_template_data_dir = f"<legacy_repo_root>/gameformer/nuplan_preprocess/prompts_templates/{scenario_type}.txt"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, help='path to raw data', default='<internal_dataset_root>/nuplan/train/data/cache/train_combined')
    ...
    parser.add_argument('--save_path', type=str, help='path to save processed data', default='<internal_dataset_root>/nuplan/gpt_prompt_14types_v02_5clsDirections')
